...
# define WELCOME_01 "Welcome to cri_ft !\n"

// # define ERR_PWD "Enter server password: PASS <password>\n"
...
// # define ERR_NCK_USR "Please enter a username or a nickname: USER <username> or NICK <nickname>\n"
